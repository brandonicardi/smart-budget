  ...
  return (
    <Link href={'/dashboard/expenses/'+budget?.id} className='p-5 border rounded-lg hover:shadow-md cursor-pointer'>
        ...
        <div>
            ...
            <h2 className='text-sm text-gray-500'>{budget.totalItem} Artículos</h2>
            </div>
        </div>
        ...
        <div className='mt-5'>
            <div className='flex items-center justify-between mb-3'>
                <h2 className='text-xs text-slate-400'>${budget.totalSpend?budget.totalSpend:0} Gastado</h2>
                <h2 className='text-xs text-slate-400'>${budget.amount-budget.totalSpend} Restante</h2>
            </div>

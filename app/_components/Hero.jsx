...
function Hero() {
  return (
        ...
        lg:flex">
            ...
            Maneja tus gastos
                <strong className="font-extrabold text-primary sm:block"> Controla tu economia </strong>
            </h1>

            <p className="mt-4 sm:text-xl/relaxed">
            Comienza hoy creando tu presupuesto mensual y consigue un mayor rendimiento en tus ahorros.
            </p>
